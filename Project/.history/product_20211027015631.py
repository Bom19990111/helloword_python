...
def UpdateProduct():
    ...
    while action >= 0:
        ...
        def UpdateProductBrand():
            print("Nhập thương hiệu muốn cập nhật của sản phẩm: ")
            name_product = input()
            product[1]['Brand'] = name_product

        def UpdateProductPrice():
            print("Nhập giá muốn cập nhật của sản phẩm")
            name_product = float(input())
            product[1]['Price'] = name_product

        def UpdateProductSize():
            print("Nhập size muốn cập nhật của sản phẩm")
            name_product = input()
            product[1]['Size'] = name_product

        def UpdateProductYear():
            print("Nhập năm sản xuất muốn cập nhật của sản phẩm")
