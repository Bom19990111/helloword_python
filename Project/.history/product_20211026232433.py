...
def FindProductByName():
    ...
    for i in range(0, len(list_product.list_product)):
        if str(list_product.list_product[i]['Product_name']).upper() in NameProduct or str(list_product.list_product[i]['Brand']).upper() in NameProduct:
            new_list.append(i)      
            print(new_list)
            print("ID: ", list_product.new_list[i]['Id']),
            print("Mã sản phẩm: ",
                list_product.new_list[i]['Product_code']),
            print("Tên sản phẩm: ",
                list_product.new_list[i]['Product_name']),
            print("Thương hiệu: ", list_product.new_list[i]['Brand']),
            print("Giá: ", list_product.new_list[i]['Price']),
            print("Năm xuất bản: ", list_product.new_list[i]['Year']),
            print("Số lượng: ", list_product.new_list[i]['Quantity']),
            print("Size giày: ", list_product.new_list[i]['Size'])
            print("________________________________")
    else:      
