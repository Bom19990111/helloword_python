...
def AddProduct():
    ...
    pd = list_product("1", "Truyện bảy viên ngọc rồng",
                      20000, "Truyện tranh nhật bản")


    pd2 = product("2", "Cho tôi xin 1 vé đi tuổi thơ",
                10000, "Sách Nguyễn Ngọc Ánh")
    pd3 = product("3", "Ánh sáng cuối con đường", 30000, "TurtleMe")
    list_product.list_product.append(pd)
    list_product.list_product.append(pd2)
    list_product.list_product.append(pd3)
